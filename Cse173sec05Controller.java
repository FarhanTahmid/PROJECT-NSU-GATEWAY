...
public class Cse173sec05Controller implements Initializable {
	
    @FXML
    private TableView<CourseStudentListInfo> cse173sec05;
	 @FXML
	    ...
	    void sendMail(ActionEvent event) throws IOException {
	        	...
	        	datafrombutton=this.cse173sec05.getSelectionModel().getSelectedItem();
	        	...
	        	for(int i=0;i<info.size();i++) {
	        		Cse173sec05Controller.emaild=info.get(i).getEmail();
	        	}
	        	...
	        	passer.getRecieverid(Cse173sec05Controller.emaild);
		...
		public void initialize(URL arg0, ResourceBundle arg1) {
			try {
				...
				reader=new Scanner(new File("src//FacultyFiles//CSE173.5SRF1.csv"));
				reader.useDelimiter("[,\n]");
			...
			sortedStudentList.comparatorProperty().bind(cse173sec05.comparatorProperty());
			
			
			this.cse173sec05.setItems(sortData);
