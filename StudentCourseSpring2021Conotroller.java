...
public class StudentCourseSpring2021Conotroller implements Initializable {
    ...
    String filepath="src//StudentCoursesHistory//Spring 2021_courses_F.csv";
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		try {
			...
			if(found) {
				...
				PrintWriter writer=new PrintWriter(new File("src//StudentCoursesHistory//tempspring2021.csv"));
		...
		this.Spring21Courses.setItems(courseData);
	}
