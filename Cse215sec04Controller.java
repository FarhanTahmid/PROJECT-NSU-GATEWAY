...
public class Cse215sec04Controller implements Initializable {

    @FXML
    private TableView<CourseStudentListInfo> cse215sec04;
	 ...
	 @FXML
	    ...
	    void sendMail(ActionEvent event) throws IOException {
        	...
        	datafrombutton=this.cse215sec04.getSelectionModel().getSelectedItem();
		...
		public void initialize(URL arg0, ResourceBundle arg1) {
			try {
				...
				reader=new Scanner(new File("src//FacultyFiles//CSE215.4SRF1.csv"));
				reader.useDelimiter("[,\n]");
			...
			sortedStudentList.comparatorProperty().bind(cse215sec04.comparatorProperty());
			
			
			this.cse215sec04.setItems(sortData);
