...
public class Cse215Sec03Controller implements Initializable{

    @FXML
    private TableView<CourseStudentListInfo> cse215sec03;
    ...
    void sendMail(ActionEvent event) throws IOException {
    	...
    	datafrombutton=this.cse215sec03.getSelectionModel().getSelectedItem();
    	...
    	for(int i=0;i<info.size();i++) {
    		Cse215Sec03Controller.emaild=info.get(i).getEmail();
    	}
    	...
    	passer.getRecieverid(Cse215Sec03Controller.emaild);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		try {
			...
			reader=new Scanner(new File("src//FacultyFiles//CSE215.3SRF1.csv"));
			reader.useDelimiter("[,\n]");
		...
		sortedStudentList.comparatorProperty().bind(cse215sec03.comparatorProperty());
		
		
		this.cse215sec03.setItems(sortData);
