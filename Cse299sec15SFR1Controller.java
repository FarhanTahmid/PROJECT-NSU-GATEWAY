...
public class Cse299sec15SFR1Controller implements Initializable{

    @FXML
    private TableView<CourseStudentListInfo> cse299;
    ...
    void sendMail(ActionEvent event) throws IOException {
    	...
    	datafrombutton=this.cse299.getSelectionModel().getSelectedItem();
    	...
    	for(int i=0;i<info.size();i++) {
    		Cse299sec15SFR1Controller.emaild=info.get(i).getEmail();
    	}
    	...
    	passer.getRecieverid(Cse299sec15SFR1Controller.emaild);
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		try {
			...
			reader=new Scanner(new File("src//FacultyFiles//CSE299.15SRF1.csv"));
			reader.useDelimiter("[,\n]");
		...
		sortedStudentList.comparatorProperty().bind(cse299.comparatorProperty());
		
		
		this.cse299.setItems(sortData);
